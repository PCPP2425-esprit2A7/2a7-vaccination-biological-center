...
void DnaWindow::setupConnections()
{
    ...
    connect(ui->runSimulationButton, &QPushButton::clicked,
            this, &DnaWindow::on_runSimulationButton_clicked);
    ...
    connect(ui->analyzeResponseButton, &QPushButton::clicked,
            this, &DnaWindow::on_analyzeResponseButton_clicked);

    connect(ui->importPatientDataButton, &QPushButton::clicked,
            this, &DnaWindow::on_importPatientDataButton_clicked);
    connect(ui->importViralDataButton, &QPushButton::clicked,
            this, &DnaWindow::on_importViralDataButton_clicked);
    ...
    connect(ui->exportPdfButton, &QPushButton::clicked, this, &DnaWindow::exportAnalysisToPdf);
}
...
void DnaWindow::exportAnalysisToPdf()
{
    if (m_simulationResults.isEmpty()) {
...
bool DnaWindow::validateInputs()
{
    ...
    ui->runSimulationButton->setEnabled(valid);
    return valid;
}

void DnaWindow::on_importPatientDataButton_clicked()
{
...
void DnaWindow::on_runSimulationButton_clicked()
{
    if (!validateInputs()) {
...
void DnaWindow::on_importViralDataButton_clicked()
{
...
void DnaWindow::on_analyzeResponseButton_clicked()
{
    if (m_simulationResults.isEmpty()) {
