...
void SimulationDialog::on_aiEnhanceButton_clicked()
{
    ...
    // Create a new AIAssistantWindow instance each time
    AIAssistantWindow aiWindow(this);

    // Prepare a comprehensive prompt for the AI with all simulation parameters
