/********************************************************************************
** Form generated from reading UI file 'dnawindowp.ui'
**
...
#ifndef UI_DNAWINDOWP_H
#define UI_DNAWINDOWP_H
...
public:
    ...
    QPushButton *importPatientDataButtonp;
    ...
    QPushButton *importViralDataButtonp;
    ...
    QPushButton *runSimulationButtonp;
    ...
    QPushButton *analyzeResponseButtonp;
    QPushButton *exportPdfButtonp;
...
"border-radius:10px;"));
        ...
        importPatientDataButtonp = new QPushButton(geneticGroupBox);
        importPatientDataButtonp->setObjectName("importPatientDataButtonp");
        importPatientDataButtonp->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:20px;\n"
"background-color:#030C54;\n"
"color:white"));

        verticalLayout_3->addWidget(importPatientDataButtonp);
...
"color: #030C54;"));
        ...
        importViralDataButtonp = new QPushButton(viralGroupBox);
        importViralDataButtonp->setObjectName("importViralDataButtonp");
        importViralDataButtonp->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:20px;\n"
"background-color:#226597;\n"
"color:white"));

        formLayout_2->setWidget(2, QFormLayout::FieldRole, importViralDataButtonp);
...
"color: #030C54;"));
        ...
        runSimulationButtonp = new QPushButton(inputGroupBox);
        runSimulationButtonp->setObjectName("runSimulationButtonp");
        runSimulationButtonp->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:20px;\n"
"background-color:#030C54;\n"
"color:white"));

        buttonLayout->addWidget(runSimulationButtonp);
...
"border-radius:10px;"));
        ...
        analyzeResponseButtonp = new QPushButton(resultsWidget);
        analyzeResponseButtonp->setObjectName("analyzeResponseButtonp");
        analyzeResponseButtonp->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:20px;\n"
"background-color:#030C54;\n"
"color:white"));

        resultButtonsLayout->addWidget(analyzeResponseButtonp);

        exportPdfButtonp = new QPushButton(resultsWidget);
        exportPdfButtonp->setObjectName("exportPdfButtonp");
        exportPdfButtonp->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:20px;\n"
"background-color:#226597;\n"
"color:white"));

        resultButtonsLayout->addWidget(exportPdfButtonp);
...
"color:white"));
    ...
    void retranslateUi(QMainWindow *DnaWindow)
    {
        ...
        importPatientDataButtonp->setText(QCoreApplication::translate("DnaWindow", "Import Patient Data", nullptr));
        ...
        importViralDataButtonp->setText(QCoreApplication::translate("DnaWindow", "Import Viral Data", nullptr));
        ...
        runSimulationButtonp->setText(QCoreApplication::translate("DnaWindow", "Run Simulation", nullptr));
        ...
        analyzeResponseButtonp->setText(QCoreApplication::translate("DnaWindow", "Analyze Response", nullptr));
        exportPdfButtonp->setText(QCoreApplication::translate("DnaWindow", "Export Results", nullptr));
