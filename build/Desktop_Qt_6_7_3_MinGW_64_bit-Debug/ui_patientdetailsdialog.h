/********************************************************************************
** Form generated from reading UI file 'patientdetailsdialog.ui'
**
...
#ifndef UI_PATIENTDETAILSDIALOG_H
#define UI_PATIENTDETAILSDIALOG_H
...
"border: 1px solid gray;"));
        ...
        browseButton = new QPushButton(patientInfoFrame);
        browseButton->setObjectName("browseButton");
        browseButton->setEnabled(false);
        browseButton->setGeometry(QRect(290, 390, 91, 31));
...
"color:#030C54"));
        ...
        cancelButton->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:20px;\n"
"background-color:#030C54;\n"
"color:white"));
...
"color:white"));
        ...
        actionButtonLayout->addWidget(editButton);

        modifyButton = new QPushButton(layoutWidget);
        modifyButton->setObjectName("modifyButton");
        modifyButton->setEnabled(false);
        modifyButton->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:15px;\n"
"background-color:#030C54;\n"
"color:white"));

        actionButtonLayout->addWidget(modifyButton);
...
"color:#030C54"));
        ...
        viewButton = new QPushButton(layoutWidget_3);
        viewButton->setObjectName("viewButton");
        viewButton->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:15px;\n"
"background-color:#030C54;\n"
"color:white"));

        documentButtonLayout->addWidget(viewButton);

        saveButton = new QPushButton(layoutWidget_3);
        saveButton->setObjectName("saveButton");
        saveButton->setStyleSheet(QString::fromUtf8("border:1px solid white;\n"
"border-radius:15px;\n"
"background-color:#030C54;\n"
"color:white"));

        documentButtonLayout->addWidget(saveButton);

        pdfButton = new QPushButton(layoutWidget_3);
...
"color:white"));
        ...
        documentButtonLayout->addWidget(pdfButton);
    ...
    void retranslateUi(QDialog *PatientDetailsDialog)
    {
        ...
        browseButton->setText(QCoreApplication::translate("PatientDetailsDialog", "Parcourir...", nullptr));
        ...
        cancelButton->setText(QCoreApplication::translate("PatientDetailsDialog", "Fermer", nullptr));
        editButton->setText(QCoreApplication::translate("PatientDetailsDialog", "Modifier", nullptr));
        modifyButton->setText(QCoreApplication::translate("PatientDetailsDialog", "Enregistrer", nullptr));
        deleteButton->setText(QCoreApplication::translate("PatientDetailsDialog", "Supprimer", nullptr));
        documentPreviewTitle->setText(QCoreApplication::translate("PatientDetailsDialog", "Aper\303\247u du Document", nullptr));
        viewButton->setText(QCoreApplication::translate("PatientDetailsDialog", "Voir Document", nullptr));
        saveButton->setText(QCoreApplication::translate("PatientDetailsDialog", "Enregistrer Document", nullptr));
        pdfButton->setText(QCoreApplication::translate("PatientDetailsDialog", "Exporter PDF", nullptr));
    } // retranslateUi
...
#endif // UI_PATIENTDETAILSDIALOG_H
